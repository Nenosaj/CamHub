  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/system_update': (context) =>
            const SystemUpdatePage(), // Define ChatPage in a separate file
        '/bug_report': (context) =>
            const BugReportPage(), // Define NotificationsPage in a separate file
        '/approval': (context) =>
            const ApprovalPage(), // Define ProfilePage in a separate file
